    ...
    <div class="modal" v-if="isModalVisible">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>
            Một trong những công ty thành viên của Tập đoàn FPT là FPT Software,
            hiện là công ty xuất khẩu dịch vụ phần mềm có mặt tại 11 quốc gia
            trên thế giới và lớn nhất Đông Nam Á.
          </p>
          <p>
            Đặt tại Việt Nam 3 trụ sở chính FPT Software, và một số nước trên
            toàn thế giới như Malaysia, Đức, Úc, Nhật Bản, Hoa Kỳ, Singapore,
            Malaysia, Thái Lan và Philipines.
          </p>
          <p>
            Được thành lập từ năm 1988, hiện FPT Software đáp ứng nhu cầu tại 20
            quốc gia lớn nhất trên thế giới với hơn 150 công ty hàng đầu như
            Hitachi, NEOPOST, Petronas, Deutsche Bank, và Unilever có khi đạt cả
            1 triệu USD với hơn 4000 nhân viên trên toàn thế giới.
          </p>
        </div>
      </div>
    </div>
    ...
    const fetchEmployers = async () => {
      try {
        const response = await axios.get(
          "https://job-api.mrun.site/api/jobs/getAll"
        );
